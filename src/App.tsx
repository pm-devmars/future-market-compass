...
const App: React.FC = () => {
  ...
  const [walletAddressInput, setWalletAddressInput] = useState<string>('0xdde7f1e4a512e483f822000ae246fd8f5a19ca8b'); // <<< IMPORTANT: Replace with a real default wallet address (or comma-separated list)
